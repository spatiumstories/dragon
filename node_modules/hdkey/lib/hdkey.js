...
HDKey.prototype.derive = function (path, nonStandard) {
  ...
  entries.forEach(function (c, i) {
    ...
    hdkey = hdkey.deriveChild(childIndex, nonStandard)
  })

  return hdkey
}

HDKey.prototype.deriveChild = function (index, nonStandard) {
  ...
  if (isHardened) { // Hardened child
    ...
    if (nonStandard && pk[0] === 0) {
      pk = Buffer.concat([pk.slice(1), zb])
    }
