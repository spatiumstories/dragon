...
export declare class Social {
    ...
    sendMessageWithoutIdentity: (request: Partial<SendMessageStatelessRequest>) => Promise<any>;
    ...
    getMessagesStatelessV3(request: GetMessagesStatelessRequest): Promise<any>;
    ...
    checkPartyMessagingKey(request: Partial<CheckPartyMessagingKeysRequest>): Promise<CheckPartyMessagingKeysResponse>;
}
